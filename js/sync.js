...
function loveLive(roomnum) {
    ...
    var video_roulette = [
        'Z-9iyiuNaq4','P1z4Uy3sEvE','0cjhwqdy4x4','gLiQJvcWrUk',
        'gWcILbCt1zA','MwGkIjL1I50','pcEhkmkv87M','eHoIUNY-bG4',
        'psi5C9WM3i0','DScFlfN9vDk','Jgd3-FdsoRQ','UEupjQbTruo',
        '0IxPZ_TlRYQ','2WHWgOjSY_o','WczCW9C29-Q','DZbrZbeqvGU',
        'bQsSrvfPfNM','sgVY2VBhsQ4','IJks4meO_5Q','fL20xsEARPk'
    ]
